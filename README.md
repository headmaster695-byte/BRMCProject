...
- Third P0 palette is registered (`floors/third-dimension/block-palette.md`) and generated into the Third dest climate only (`cold_garage`). Hard break from Second crimson: sodium fluorescent, wet concrete, lying stall paint, ramp-door liar mouth. Fill is `third_concrete`, never gray void. Chainlink / crate / headlights stay unregistered. No Third entities. No new live First / Second plane-cross — glance with `/brmc third`. **Regen Third chunks.**
