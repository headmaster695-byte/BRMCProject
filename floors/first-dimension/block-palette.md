...
Apartment / utilities still use vanilla material-break stand-ins. Second dest climate is P0 `brmc:second_*`. Third dest climate is P0 `brmc:third_*` (`floors/third-dimension/block-palette.md`). False First dest stays yellow-mono vanilla this pass.
