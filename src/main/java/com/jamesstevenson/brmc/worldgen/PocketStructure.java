...
public enum PocketStructure {
	CLARK_CHAMBER("first-clark-chamber", "Authored 32×32 cold-open. Chevron family, moist-carpet read, troffer grid, empty segmented volume into the labyrinth. No store/basement/portal/tutorial."),
